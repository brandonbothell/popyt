...
sidebar_position: 1
---
import CodeBlock, { CodeSandboxText } from '@theme/CodeBlock'
...
Get started by [creating a new Node.JS project](https://docs.npmjs.com/cli/v9/commands/npm-init#examples) and running
