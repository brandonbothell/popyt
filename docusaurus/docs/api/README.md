...
Note: This wrapper does not implement every feature of the YouTube API. If you would like anything added, feel free to open an issue or pull request. The limits imposed by the wrapper are not imposed by YouTube.
